// <MDBCarousel showControls showIndicators dark fade me>
//     <MDBCarouselItem
//         className='w-100 d-block carousel-image '
//         itemId={1}
//         src='./image/slider/img-top-store2.jpg'
...
//         className='w-100 d-block carousel-image'
//         itemId={2}
//         src='./image/slider/slider2-store2.jpg'
//         alt='Image is not Found..!'
//     >
...
async LoginUser(req, res) {
    try {
        ...
        await user.save(); // Save the updated user document with the new token
